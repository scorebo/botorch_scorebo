...
import botorch.acquisition.active_learning as active_learning
...
def get_acquisition_function(
    ...
    **kwargs,
    ...
    elif acquisition_function_name == "BALM":
        return active_learning.BALM(
            model=model,
            objective=objective,
            posterior_transform=posterior_transform,
        )
    elif acquisition_function_name == "BALD":
        return active_learning.BALD(
            model=model,
            objective=objective,
            posterior_transform=posterior_transform,
        )
    elif acquisition_function_name == "QBMGP":
        return active_learning.QBMGP(
            model=model,
            objective=objective,
            posterior_transform=posterior_transform,
        )
    elif acquisition_function_name == "BQBC":
        return active_learning.BQBC(
            model=model,
            objective=objective,
            posterior_transform=posterior_transform,
        )
    elif acquisition_function_name == "SAL_WS":
        return active_learning.StatisticalDistance(
            model=model,
            objective=objective,
            posterior_transform=posterior_transform,
            noisy_distance=True,
    ...
    elif acquisition_function_name == "SAL_BC":
        return active_learning.StatisticalDistance(
            model=model,
            objective=objective,
            posterior_transform=posterior_transform,
    ...
    elif acquisition_function_name == "SAL_HR":
        return active_learning.StatisticalDistance(
            model=model,
            objective=objective,
            posterior_transform=posterior_transform,
    ...
    elif acquisition_function_name == "SAL_JS":
        return active_learning.StatisticalDistance(
            model=model,
            objective=objective,
            posterior_transform=posterior_transform,
    ...
    elif acquisition_function_name == "SAL_KL":
        return active_learning.StatisticalDistance(
            model=model,
            objective=objective,
            posterior_transform=posterior_transform,
